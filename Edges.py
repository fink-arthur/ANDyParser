...
class Edges:
    ...
    def makeEdge(self, source, target, expression, name):
        ...
        accumulator += "<![CDATA[]]>\n\n<graphics count=\"1\">\n"
        accumulator += "<graphic xoff=\"40.00\" x=\"250.00\" y=\"140.00\" id=\"" + str(self.iterator.next()) + "\" net=\"1\" "
        ...
        accumulator += "<![CDATA[1]]>\n<graphics count=\"1\">\n"
        accumulator += "<graphic xoff=\"20.00\" x=\"230.00\" y=\"140.00\" id=\"" + str(self.iterator.next()) + "\" net=\"1\" "
        ...
        accumulator += "<graphic xoff=\"25.00\" x=\"235.00\" y=\"140.00\" id=\"" + str(self.iterator.next()) + "\" net=\"1\" "
        accumulator += "show=\"1\" grparent=\"" + str(identifier) + "\" state=\"1\" pen=\"0,0,0\" brush=\"255,255,255\"/>\n"
        accumulator += "</graphics>\n</attribute>\n<graphics count=\"1\">\n"
        accumulator += "<graphic id=\"" + str(identifier) + "\" net=\"1\" source=\""+ str(source) + "\" target=\"" + str(target) + "\" state=\"1\" "
        accumulator += "show=\"1\" pen=\"0,0,0\" brush=\"0,0,0\" edge_designtype=\"3\">\n"
        accumulator += "<points count=\"2\">\n<point x=\"180.00\" y=\"200.00\"/>\n<point x=\"260.00\" y=\"200.00\"/>\n"
        accumulator += "</points>\n</graphic>\n</graphics>\n</edge>\n"
        return accumulator
    ...
    def makeReadEdge(self, source, target, expression, name):
        ...
        accumulator += "<graphic xoff=\"40.00\" x=\"250.00\" y=\"140.00\" id=\"" + str(self.iterator.next()) + "\" net=\"1\" "
        accumulator += "show=\"1\" grparent=\"" + str(identifier) + "\" state=\"1\" pen=\"0,0,0\" brush=\"255,255,255\"/>\n</graphics>\n"
        accumulator += "<attribute name=\"ExpressionList\" type=\"ColList\" id=\"" + str(self.iterator.next()) + "\" net=\"1\">\n"
        accumulator += "<colList row_count=\"1\" col_count=\"2\" active_row=\"0\" active_col=\"0\">\n<colList_head>\n"
